...
if (layer_instance_get_instance(_elem) == id){
	if (_data == "sprite event"){
		...
		if ( _msg == "atacar"){
			...
			var _x1, _y1, _x2, _y2, _x3;
			_x1 = (sprite_get_bbox_left(sprite_index)	- sprite_xoffset);
			_y1 = (sprite_get_bbox_top(sprite_index)	- sprite_yoffset);
			_x2 = (sprite_get_bbox_right(sprite_index)	- sprite_xoffset);
			_y2 = (sprite_get_bbox_bottom(sprite_index)	- sprite_yoffset);
						
			atacar = new Dano(_x1, _y1, _x2 ,_y2, id);
		}
	}
}
